...
import 'package:owala_app/views/onboarding/component/boarding_content.dart';
        ...
        children: [
          Expanded(
            ...
            child: PageView.builder(
              ...
              // maksud dr kode ini adlah untuk meberitahu setiap kali ada perubahan 
              // disatu objek atau halaman yang ditrigger oleh adanya interaksi oleh pengguna
              onPageChanged: (value) {
                setState(() {
                  currentPage = value;
                });
